...
pairdata <- read.csv("~/FungalFightClub/CSVs/FFC Treatments - Pairwise.csv", header=TRUE)
pairdata = pairdata[pairdata$X == "",]

svsdata <- read.csv("~/FungalFightClub/CSVs/FFC Treatments - Controls SVS.csv", header=TRUE)
svsdata = svsdata[svsdata$X == "",]

sgdata <- read.csv("~/FungalFightClub/CSVs/FFC Treatments - Controls.csv", header=TRUE)
