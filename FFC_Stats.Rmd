...
stargazer(lm(mean_r~Fun_ID*PH_ID*opp_ID, data = final_data_eoc), 
          # out = "lmeocr.htm",
          type = "text",
          dep.var.labels = c("Growth Rate (r)"),
          summary = TRUE,
          digits = 3
)
...
stargazer(lm(mean_K~Fun_ID*PH_ID*opp_ID, data = final_data_eoc), 
          # out = "lmeocK.htm",
          type = "text",
          dep.var.labels = c("Colony Size (K)"),
          summary = TRUE,
          digits = 3
)
...
Tuk_geoc_fin = rbind(Tuk_rgeoc_fin,Tuk_Kgeoc_fin)
...
sig_gen_eoc = Tuk_geoc_fin[,c(6,2:5,8)]
colnames(sig_gen_eoc) = c("Fungi", "Mean Difference", "Lower Bound", "Upper Bound", "Significance", "Growth Measure")
